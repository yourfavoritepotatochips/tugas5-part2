...
unset($__errorArgs, $__bag); ?>" type="text" name="firstName" id="firstName"
                            value="<?php echo e(old('firstName')); ?>" placeholder="Enter First Name" required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="lastName" id="lastName"
...
unset($__errorArgs, $__bag); ?>" type="text" name="email" id="email"
...
unset($__errorArgs, $__bag); ?>" type="text" name="age" id="age"
...
<?php /**PATH C:\Users\User\tugas-5\resources\views/employee/create.blade.php ENDPATH**/ ?>